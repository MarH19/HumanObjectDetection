...
def user_input_choose_from_list(choices: list[Any], title: str, caption: str, list_item_label_selector: Callable[[Any], str] | None = None):
    lines = [
...
def choose_robot_motion():
    ...
    return user_input_choose_from_list(robot_motions, "Robot Motions", "Choose robot motion", lambda m: m.name)
